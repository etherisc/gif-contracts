...
interface ITreasury {
    ...
    event LogTreasuryProductTokenSet (uint256 productId, address erc20Address);
    ...
    function processCapital(uint256 bundleId, uint256 capitalAmount) external returns(bool success);
