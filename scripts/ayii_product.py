...
# class GifAreaYieldIndexOracle(object):
...
#         self.oracle = AreaYieldIndexOracle.deploy(
#             s2b32('AreaYieldIndexOracle'),
#             instance.getRegistry(),
...
# class GifAreaYieldIndexProduct(object):
...
#         riskpoolKeeper: Account,
#         customer: Account,
#         oracle: GifAreaYieldIndexOracle, 
...
#         self.product = AreaYieldIndexProduct.deploy(
#             s2b32('AreaYieldIndexProduct'),
#             registry,
#             oracle.getId(),
#             riskpool.getId(),
#             token.address,
...
#     def getOracle(self) -> GifAreaYieldIndexOracle:
#         return self.oracle
